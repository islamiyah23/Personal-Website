	...
	return (
		<section id="contact" className="space-y-6">
			...
			<p className="text-zinc-800 dark:text-zinc-200">
				Feel free to reach out if you’d like to collaborate on tech projects, discuss web development, or share ideas about programming and information systems.
			</p>
			<div className="flex gap-x-6 mt-6 flex-col md:flex-row gap-y-2">
				<span className="text-zinc-500 dark:text-zinc-300">islamiyah.kinanti@gmail.com</span>
				<a href="https://www.youtube.com/@islamiyahdinarkinanti5632" className="text-zinc-500 dark:text-zinc-300 flex items-center gap-x-2.5">
